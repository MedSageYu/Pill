...
final class SettingsManager {
    ...
    struct Settings: Codable {
        ...
        var appSettings: CoreSettings = CoreSettings()  // App-wide settings
        ...
        init(from decoder: Decoder) throws {
            ...
            var decodedAppSettings = try c.decodeIfPresent(CoreSettings.self, forKey: .appSettings) ?? CoreSettings()
    ...
    var appSettings: CoreSettings {
        get { settings.appSettings }
        set { updateAppSettings(newValue) }
    }

    func updateAppSettings(_ newSettings: CoreSettings) {
